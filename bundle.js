...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, `.modal {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modal-content-wrapper {\n  position: relative;\n  background-color: #fff;\n  margin: 15% auto;\n  padding: 20px;\n  width: 80%;\n}\n\n.modal-message {\n  color: #000;\n}\n\n.close {\n  color: #aaa;\n  position: absolute;\n  top: 10px;\n  right: 24px;\n  font-size: 36px;\n  font-weight: bold;\n  cursor: pointer;\n}\n\n.close:hover,\n.close:focus {\n  color: #000;\n  text-decoration: none;\n}\n`, \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://js-movie-review/./src/css/modal.css?./node_modules/css-loader/dist/cjs.js");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ApiClient)\n/* harmony export */ });\n/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./error */ \"./src/api/error.js\");\n\n\nconst BASE_URL = \"https://api.themoviedb.org/3\";\n\nclass ApiClient {\n  static async get(endpoint, headers = {}) {\n    return this.request(\"GET\", endpoint, null, headers);\n  }\n\n  static async request(method, endpoint, body = null, headers = {}) {\n    const url = `${BASE_URL}${endpoint}`;\n    const options = {\n      method,\n      headers: {\n        \"Content-Type\": \"application/json\",\n        ...headers,\n      },\n      body: body ? JSON.stringify(body) : null,\n    };\n\n    try {\n      const response = await fetch(url, options);\n      if (!response.ok) {\n        switch (response.status) {\n          case 401:\n            throw new _error__WEBPACK_IMPORTED_MODULE_0__.UnauthorizedError(\"Unauthorized access\");\n          default:\n            throw new _error__WEBPACK_IMPORTED_MODULE_0__.ApiError(response.status, \"An error occurred\");\n        }\n      }\n\n      const data = await response.json();\n\n      return data;\n    } catch (error) {\n      if (error instanceof Response) {\n        throw new _error__WEBPACK_IMPORTED_MODULE_0__.InternetServerError(error.message || \"Server error\");\n      }\n\n      throw error;\n    }\n  }\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/api/client.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   ApiError: () => (/* binding */ ApiError),\n/* harmony export */   InternetServerError: () => (/* binding */ InternetServerError),\n/* harmony export */   UnauthorizedError: () => (/* binding */ UnauthorizedError)\n/* harmony export */ });\nclass ApiError extends Error {\n  status;\n\n  constructor(status, message) {\n    super(message);\n    this.status = status;\n  }\n}\n\nclass UnauthorizedError extends ApiError {\n  constructor(message) {\n    super(401, message);\n  }\n}\n\nclass InternetServerError extends ApiError {\n  constructor(message) {\n    super(500, message);\n  }\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/api/error.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Movie: () => (/* binding */ Movie)\n/* harmony export */ });\n/* harmony import */ var _api_movie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/movie */ \"./src/api/movie.js\");\n\n\nclass Movie {\n  constructor() {\n    this.list = [];\n    this.currentPage = 1;\n    this.hasMore = true;\n    this.query = \"\";\n    this.observers = [];\n  }\n\n  addObserver(observer) {\n    this.observers.push(observer);\n  }\n\n  notifyObservers() {\n    this.observers.forEach((observer) => observer.update());\n  }\n\n  async fetchApi() {\n    if (this.query) {\n      return await (0,_api_movie__WEBPACK_IMPORTED_MODULE_0__.searchMovies)(this.query, this.currentPage);\n    }\n\n    return await (0,_api_movie__WEBPACK_IMPORTED_MODULE_0__.getPopularMovies)(this.currentPage);\n  }\n\n  async loadMore() {\n    if (!this.hasMore) return;\n\n    try {\n      const data = await this.fetchApi();\n      this.list.push(...data.results);\n      this.hasMore = data.page < data.total_pages;\n      this.currentPage += 1;\n      this.notifyObservers();\n    } catch (error) {\n      this.hasMore = false;\n      throw error;\n    }\n  }\n\n  setSearchQuery(query) {\n    this.query = query;\n    this.list = [];\n    this.currentPage = 1;\n    this.hasMore = true;\n    this.notifyObservers();\n  }\n}\n\n\n//# sourceURL=webpack://js-movie-review/./src/domain/Movie.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _domain_Movie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domain/Movie */ \"./src/domain/Movie.js\");\n/* harmony import */ var _views_MovieView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/MovieView */ \"./src/views/MovieView.js\");\n/* harmony import */ var _views_HeaderView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/HeaderView */ \"./src/views/HeaderView.js\");\n/* harmony import */ var _css_reset_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./css/reset.css */ \"./src/css/reset.css\");\n/* harmony import */ var _css_common_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./css/common.css */ \"./src/css/common.css\");\n/* harmony import */ var _css_modal_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./css/modal.css */ \"./src/css/modal.css\");\n\n\n\n\n\n\n\naddEventListener(\"DOMContentLoaded\", () => {\n  const movie = new _domain_Movie__WEBPACK_IMPORTED_MODULE_0__.Movie();\n\n  new _views_HeaderView__WEBPACK_IMPORTED_MODULE_2__.HeaderView(movie);\n  const movieView = new _views_MovieView__WEBPACK_IMPORTED_MODULE_1__.MovieView(movie);\n  movieView.loadMore();\n});\n\n\n//# sourceURL=webpack://js-movie-review/./src/index.js?");
